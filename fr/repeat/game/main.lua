...
function love.draw()
    ...
    love.graphics.print("appuyez sur Q ou Échap pour quitter", 750, 580)
    if show_state == 0 then
        love.graphics.print("appuyez sur n'importe quelle touche", 750, 315)
        love.graphics.print("pour démarrer", 815, 330)
    else
        love.graphics.print("score: " .. #serie-1 .. "\n" .. "vitesse: " .. sped, 750, 275)
    end
    if loose then
        love.graphics.print("faux!", 840, 300)
        love.graphics.print("appuyez sur n'importe quelle touche", 750, 315)
        love.graphics.print("pour redémarrer", 810, 330)
    elseif show_state == 2 then
        love.graphics.print("à ton tour", 830, 330)
    end
